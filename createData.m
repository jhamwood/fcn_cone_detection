...
folder = 'Confocal\Training Images\';
folder2 = 'Confocal\Training Manual Coord\';
files = dir(folder);
files = files(3:end);

mkdir('data/confocal/mat/train/imgs')
mkdir('data/confocal/mat/train/0wide')
mkdir('data/confocal/mat/train/1wide')
mkdir('data/confocal/mat/train/2wide')
mkdir('data/confocal/mat/train/3wide')
mkdir('data/confocal/mat/test/imgs')
mkdir('data/confocal/mat/test/truths')
...
for n = 1:length(files)
    ...
    if all(size(img) >= 144)
        ...
        imwrite(img(1+floor(offsetx):end-ceil(offsetx),1+floor(offsety):end-ceil(offsety)),['data/confocal/mat/train/imgs/' num2str(count) '.png']);
        ...
        imwrite(temp,['data/confocal/mat/train/0wide/' num2str(count) '.png']);
        ...
        imwrite(temp,['data/confocal/mat/train/1wide/' num2str(count) '.png']);
        ...
        imwrite(temp,['data/confocal/mat/train/2wide/' num2str(count) '.png']);
        ...
        imwrite(temp,['data/confocal/mat/train/3wide/' num2str(count) '.png']);
        
        count = count + 1;
    end
end

folder = 'Confocal\Validation Images\';
folder2 = 'Confocal\Validation Manual Coord\';
files = dir(folder);
files = files(3:end);
count = 0;
for n = 1:length(files)
    ...
    if all(size(img) >= 144)
        ...
        imwrite(img(1+floor(offsetx):end-ceil(offsetx),1+floor(offsety):end-ceil(offsety)),['data/confocal/mat/test/imgs/' num2str(count) '.png']);
        
        temp = zeros(size(img),'uint8');
        temp(sub2ind(size(img),coords(:,2),coords(:,1))) = 1;
        temp = temp(1+floor(offsetx):end-ceil(offsetx),1+floor(offsety):end-ceil(offsety));
        temp = temp + 1;
        imwrite(temp,['data/confocal/mat/test/truths/' num2str(count) '.png']);
